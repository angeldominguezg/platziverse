...
test.serial('Setup', t => {
  ...
  t.true(_rec3._expr(_rec3._capt(_rec3._capt(_rec3._capt(AgentStub, 'arguments/0/callee/object/object').hasMany, 'arguments/0/callee/object').calldWith(_rec3._capt(MetricStub, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AgentStub.hasMany.calldWith(MetricStub), \'Argument should be the Metricmodel\')',
    filepath: 'test/agent-test.js',
    line: 42,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"hasMany","range":[17,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"calldWith","range":[25,34]},"computed":false,"range":[7,34]},"arguments":[{"type":"Identifier","name":"MetricStub","range":[35,45]}],"range":[7,46]},{"type":"StringLiteral","value":"Argument should be the Metricmodel","range":[48,84]}],"range":[0,85]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"hasMany","range":[17,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"calldWith","range":[25,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"name"},"value":"MetricStub","range":[35,45]},{"type":{"label":")"},"range":[45,46]},{"type":{"label":","},"range":[46,47]},{"type":{"label":"string"},"value":"Argument should be the Metricmodel","range":[48,84]},{"type":{"label":")"},"range":[84,85]}]',
    visitorKeys: _powerAssertVisitorKeys
  ...
  t.true(_rec5._expr(_rec5._capt(_rec5._capt(_rec5._capt(MetricStub, 'arguments/0/callee/object/object').belongsTo, 'arguments/0/callee/object').calldWith(_rec5._capt(AgentStub, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(MetricStub.belongsTo.calldWith(AgentStub), \'Mtric should be the AgentModel\')',
    filepath: 'test/agent-test.js',
    line: 44,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"MetricStub","range":[7,17]},"property":{"type":"Identifier","name":"belongsTo","range":[18,27]},"computed":false,"range":[7,27]},"property":{"type":"Identifier","name":"calldWith","range":[28,37]},"computed":false,"range":[7,37]},"arguments":[{"type":"Identifier","name":"AgentStub","range":[38,47]}],"range":[7,48]},{"type":"StringLiteral","value":"Mtric should be the AgentModel","range":[50,82]}],"range":[0,83]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"MetricStub","range":[7,17]},{"type":{"label":"."},"range":[17,18]},{"type":{"label":"name"},"value":"belongsTo","range":[18,27]},{"type":{"label":"."},"range":[27,28]},{"type":{"label":"name"},"value":"calldWith","range":[28,37]},{"type":{"label":"("},"range":[37,38]},{"type":{"label":"name"},"value":"AgentStub","range":[38,47]},{"type":{"label":")"},"range":[47,48]},{"type":{"label":","},"range":[48,49]},{"type":{"label":"string"},"value":"Mtric should be the AgentModel","range":[50,82]},{"type":{"label":")"},"range":[82,83]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'Mtric should be the AgentModel');
});
//# sourceMappingURL=/Users/angeldominguez/Desktop/nodejs/Platzi/platziverse/platziverse-db/node_modules/.cache/ava/73067fc867248155c1fdbc59e3c9fdef.js.map