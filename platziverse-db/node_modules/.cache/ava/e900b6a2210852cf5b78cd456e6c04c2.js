...
test.serial('Setup', t => {
  ...
  t.true(_rec5._expr(_rec5._capt(_rec5._capt(_rec5._capt(MetricStub, 'arguments/0/callee/object/object').belongsTo, 'arguments/0/callee/object').calledWith(_rec5._capt(AgentStub, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(MetricStub.belongsTo.calledWith(AgentStub), \'Metric should be the AgentModel\')',
    filepath: 'tests/agent-test.js',
    line: 68,
...
test.serial('Agent#createOrUpdate', async t => {
  ...
  t.true(_rec9._expr(_rec9._capt(_rec9._capt(_rec9._capt(AgentStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledTwice, 'arguments/0'), {
  ...
  t.true(_rec10._expr(_rec10._capt(_rec10._capt(_rec10._capt(AgentStub, 'arguments/0/object/object').update, 'arguments/0/object').calledTwice, 'arguments/0'), {
    content: 't.true(AgentStub.update.calledTwice, \'update should be called once\')',
    filepath: 'tests/agent-test.js',
    line: 84,
    async: true,
    ...
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"update","range":[17,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledTwice","range":[24,35]},{"type":{"label":","},"range":[35,36]},{"type":{"label":"string"},"value":"update should be called once","range":[37,67]},{"type":{"label":")"},"range":[67,68]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'update should be called once');
  t.deepEqual(agent, single, 'Agent should be the same');
});
//# sourceMappingURL=/Users/angeldominguez/Desktop/nodejs/Platzi/platziverse/platziverse-db/node_modules/.cache/ava/e900b6a2210852cf5b78cd456e6c04c2.js.map